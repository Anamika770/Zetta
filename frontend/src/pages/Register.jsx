    ...
    <div className="min-h-screen bg-gradient-to-br from-zinc-900 to-zinc-800 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="bg-zinc-700 rounded-lg shadow-2xl p-8 border border-zinc-600">
          <h1 className="text-3xl font-bold text-amber-50 mb-8 text-center">Register</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-amber-50 font-medium mb-2">
                Confirm Password
              </label>
              <input
                type="password"
